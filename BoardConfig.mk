...
# Kernel
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x237 ehci-hcd.park=3 cma=32M@0-0xffffffff loop.max_part=7 swiotlb=2048
...
TARGET_KERNEL_CONFIG := shady_oneplus3_defconfig
